...
import {
  ...
  , Loading, Empty, Divider, Picker, DatetimePicker
} from 'vant'

Vue.use(Button)
  .use(Cell).use(CellGroup).use(Card).use(Popup).use(Icon)
  ...
  .use(Loading).use(Empty).use(Divider).use(Picker).use(DatetimePicker)
